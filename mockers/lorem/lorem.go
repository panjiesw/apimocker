...
// Word Generate a natural word len.
func Word(min, max int) string {
	n := utils.IntRange(min, max)
	return word(n)
}
...
// Paragraph Generate a paragraph with a specified range of sentenences.
